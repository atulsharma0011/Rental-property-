      ...
      <div className="footer__container container grid">
        <div className="footer__content grid">
          <div className="footer__data">
            ...
            <p className="footer__description">Explore Your Destinations <br />You choose the destination, 
<br/> we provide the experience. 
        ...
        <div className="footer__rights">
          <p className="footer__copy">Experience comfort and convenience with Apna Ghar!</p>
